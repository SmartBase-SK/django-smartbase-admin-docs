...
class FilteredRoleConfiguration(SBAdminRoleConfiguration):
    """Role configuration with global filter support."""
...
class SBAdminConfiguration(SBAdminConfigurationBase):
    ...
    def get_configuration_for_roles(self, user_roles):
        return FilteredRoleConfiguration(
            # ... menu_items, default_view, registered_views
        )
```
